...
// Type: Intermech.Reports.Tasks.ReportsCreateVersionTask
...
/// <summary>Класс создания версии комплекта документов</summary>
/// <summary>
/// 
/// </summary>
/// <param name="taskParams"></param>
internal class ReportsCreateVersionTask(IReportTaskParams taskParams) : 
  ReportsGenerateTask(taskParams),
  IReportsCreateVersionTask,
  IReportsBaseTask
{
  ...
  {
    return base.ValidateParams() != ExpertResult.OK || this.Params.PackageObjId == 0L ? ExpertResult.NoCalcParms : ExpertResult.OK;
  }
  ...
  protected override ExpertResult ExecuteInternal(out List<ChangeInfo> changeLog)
  {
    ...
    return this._expertSrv.CreateComplectVersion(new CompGenParms(this.ExpertTaskId, this.Params.ScriptObjId, this.Params.ObjectId, this.Params.PackageObjId)
    {
