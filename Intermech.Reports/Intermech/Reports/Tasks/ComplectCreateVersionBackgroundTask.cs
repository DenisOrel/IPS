...
// Type: Intermech.Reports.Tasks.ComplectCreateVersionBackgroundTask
...
/// <summary>Класс создания версии комплекта в фоновом режиме</summary>
/// <summary>Конструктор</summary>
/// <param name="paramObjects"></param>
internal class ComplectCreateVersionBackgroundTask(IReportTaskParams taskParams) : 
  ComplectBackgroundBaseTask(taskParams),
  IReportBackgroundCreateVersionTask,
  ...
  IBackgroundTask
{
  ...
  {
    this._reportsTask = (ReportsBaseTask) new ReportsCreateVersionTask(this.Params);
  }
  ...
  {
    base.InitializeData();
    this._category = LocalizationHolder.rm.GetString("Reports_38");
    this._name = $"{this._category} \"{this.ObjectInfo.Caption}\"";
    this.Value = (object) 0;
    this.MinimumValue = 0;
  }
}
