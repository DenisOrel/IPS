...
// Type: Intermech.Reports.Tasks.ComplectUpdateBackgroundTask
...
/// <summary>Класс обновления комплекта в фоновом режиме</summary>
/// <summary>Конструктор</summary>
/// <param name="paramsObjects"></param>
internal class ComplectUpdateBackgroundTask(IReportTaskParams taskParams) : 
  ComplectCreateVersionBackgroundTask(taskParams),
  IReportBackgroundUpdateTask,
  ...
  IBackgroundTask
{
  ...
  {
    this._reportsTask = (ReportsBaseTask) new ReportsUpdateTask(this.Params);
  }
  ...
  {
    base.InitializeData();
    this._category = LocalizationHolder.rm.GetString("Reports_3");
