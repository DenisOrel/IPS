...
// Type: Intermech.Statistics.Controls.ExcludeValuesForCommandsCntrl
...
public class ExcludeValuesForCommandsCntrl : UserControl
{
  ...
  private CheckBox cbExcludeNotWorkingDays;
  ...
  public bool IgnoreNotWorkingDays
  {
    get => this.cbExcludeNotWorkingDays.Checked;
    set => this.cbExcludeNotWorkingDays.Checked = value;
  }

  public bool IgnoreWorkingDaysEnable
  {
    set
    {
      this.cbExcludeNotWorkingDays.Enabled = value;
      if (value)
        return;
      this.cbExcludeNotWorkingDays.CheckState = CheckState.Unchecked;
    }
  }
  ...
  public ExcludeValuesForCommandsCntrl() => this.InitializeComponent();
  ...
  private void cbExcludeNotWorkingDays_CheckedChanged(object sender, EventArgs e) => this.Modify();
  ...
  private void InitializeComponent()
  {
    ...
    this.cbExcludeNotWorkingDays = new CheckBox();
    this.tbPercent = new TextBox();
    this.label4 = new Label();
    this.cbExcludeAbnormalValues = new CheckBox();
    this.groupBox2.SuspendLayout();
    this.SuspendLayout();
    this.groupBox2.Controls.Add((Control) this.cbExcludeNotWorkingDays);
    ...
    this.groupBox2.Size = new Size(597, 74);
    this.groupBox2.TabIndex = 12;
    this.groupBox2.TabStop = false;
    this.groupBox2.Text = "Исключение  результатов";
    this.cbExcludeNotWorkingDays.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
    this.cbExcludeNotWorkingDays.AutoSize = true;
    this.cbExcludeNotWorkingDays.Enabled = false;
    this.cbExcludeNotWorkingDays.Location = new Point(6, 43);
    this.cbExcludeNotWorkingDays.Name = "cbExcludeNotWorkingDays";
    this.cbExcludeNotWorkingDays.Size = new Size(249, 17);
    this.cbExcludeNotWorkingDays.TabIndex = 3;
    this.cbExcludeNotWorkingDays.Text = "Не учитывать выходные и праздничные дни";
    this.cbExcludeNotWorkingDays.UseVisualStyleBackColor = true;
    this.cbExcludeNotWorkingDays.CheckedChanged += new EventHandler(this.cbExcludeNotWorkingDays_CheckedChanged);
    ...
    this.Name = nameof (ExcludeValuesForCommandsCntrl);
    this.Size = new Size(597, 74);
