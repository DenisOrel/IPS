...
// Type: Intermech.Statistics.Configurations.LCStepDateConfigsForm
...
public class LCStepDateConfigsForm : Form, IStatisticSettingsForm
{
  ...
  public LCStepDateConfigsForm(CommandSettings commandSettings = null)
  {
  ...
  private void InitFormBySettings(CommandSettings commandSettings)
  {
    ...
    this._step = commandSettings.LCStep;
    if (!string.IsNullOrEmpty(this._step) && !string.IsNullOrWhiteSpace(this._step))
      this.lbStep.Text = MetaDataHelper.GetLCStepName(new Guid(this._step));
  ...
  {
    this.analyzeObjectTypeControl1.Init(CommandStatisticsTypesEnum.LCStepDate);
    this.filtersControl.Init(CommandStatisticsTypesEnum.LCStepDate);
  ...
  private void lcStepGuidAdd_Click(object sender, EventArgs e)
  {
    SelectLCStep selectLcStep = new SelectLCStep(MetaDataHelper.GetLCStepsList());
    if (selectLcStep.ShowDialog() == DialogResult.OK)
    {
      this._step = selectLcStep.SelectedItem.Tag.ToString();
      this.lbStep.Text = selectLcStep.SelectedItem.Text;
    }
    this.Modify();
  }
  ...
  private void btnOK_Click(object sender, EventArgs e)
  {
    ...
    if (string.IsNullOrEmpty(this._step))
    {
      dialogResult = MessageBox.Show("В настройках не задан GUID шага ЖЦ для которого должен производиться подсчет статистики. Все равно продолжить?", "Внимание", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
    ...
    if (dialogResult == DialogResult.Yes)
    {
      CommandSettings commandSettings1 = new CommandSettings()
      {
        ...
        CommandType = CommandStatisticsTypesEnum.LCStepDate,
        LCStep = this._step,
  ...
  private void InitializeComponent()
  {
    ...
    this.btnCancel.Location = new Point(595, 3);
    ...
    this.btnOK.Location = new Point(500, 3);
    ...
    this.config.Location = new Point(2, 1);
    this.config.Name = "config";
    this.config.SelectedIndex = 0;
    this.config.Size = new Size(688, 463);
    ...
    this.createdDateCommandSettings.Controls.Add((Control) this.gbLCStep);
    ...
    this.createdDateCommandSettings.Size = new Size(680, 437);
    this.createdDateCommandSettings.TabIndex = 0;
    this.createdDateCommandSettings.Text = "Настройки сбора статистики по дате перемещения на шаг ЖЦ";
    this.gbLCStep.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
    this.gbLCStep.Controls.Add((Control) this.lbStep);
    this.gbLCStep.Controls.Add((Control) this.lcLevelAdd);
    this.gbLCStep.Location = new Point(6, 203);
    this.gbLCStep.Name = "gbLCStep";
    this.gbLCStep.Size = new Size(664, 49);
    this.gbLCStep.TabIndex = 16 /*0x10*/;
    ...
    this.lbStep.BackColor = SystemColors.ControlLightLight;
    this.lbStep.BorderStyle = BorderStyle.FixedSingle;
    this.lbStep.Location = new Point(5, 16 /*0x10*/);
    this.lbStep.Name = "lbStep";
    this.lbStep.Size = new Size(621, 23);
    this.lbStep.TabIndex = 15;
    this.lbStep.TextAlign = ContentAlignment.MiddleLeft;
    ...
    this.lcLevelAdd.Font = new Font("Tahoma", 6f, FontStyle.Bold, GraphicsUnit.Point, (byte) 204);
    this.lcLevelAdd.Location = new Point(632, 16 /*0x10*/);
    ...
    this.lcLevelAdd.Click += new EventHandler(this.lcStepGuidAdd_Click);
    this.excludeValuesCntrl.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
    this.excludeValuesCntrl.IgnoreNotWorkingDays = false;
    this.excludeValuesCntrl.Location = new Point(9, (int) sbyte.MaxValue);
    this.excludeValuesCntrl.Name = "excludeValuesCntrl";
    this.excludeValuesCntrl.NeedExcludeAbnormalValues = true;
    this.excludeValuesCntrl.Percent = "200";
    this.excludeValuesCntrl.Size = new Size(664, 70);
    ...
    this.groupBox1.Size = new Size(664, 114);
    ...
    this.comboBox1.Size = new Size(474, 21);
    ...
    this.startDate.Size = new Size(384, 20);
    ...
    this.startTime.Location = new Point(572, 10);
    ...
    this.endDate.Size = new Size(384, 20);
    ...
    this.endTime.Location = new Point(571, 47);
    ...
    this.generalSettings.AutoScroll = true;
    ...
    this.generalSettings.Size = new Size(680, 437);
    ...
    this.tabControl2.Size = new Size(674, 431);
    this.tabControl2.TabIndex = 0;
    this.objectsTypes.BackColor = SystemColors.Control;
    ...
    this.objectsTypes.Size = new Size(666, 405);
    ...
    this.analyzeObjectTypeControl1.BackColor = SystemColors.ControlLightLight;
    ...
    this.analyzeObjectTypeControl1.Size = new Size(660, 399);
    ...
    this.panel1.Location = new Point(2, 466);
    this.panel1.Name = "panel1";
    this.panel1.Size = new Size(694, 36);
    this.panel1.TabIndex = 24;
    this.AcceptButton = (IButtonControl) this.btnOK;
    this.AutoScaleDimensions = new SizeF(6f, 13f);
    this.AutoScaleMode = AutoScaleMode.Font;
    this.CancelButton = (IButtonControl) this.btnCancel;
    this.ClientSize = new Size(699, 505);
    this.Controls.Add((Control) this.panel1);
    this.Controls.Add((Control) this.config);
    this.MinimumSize = new Size(660, 440);
    this.Name = nameof (LCStepDateConfigsForm);
