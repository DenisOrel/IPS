...
// Type: Intermech.Statistics.Configurations.ProcessTemplateConfigsForm
...
public class ProcessTemplateConfigsForm : Form, IStatisticSettingsForm
{
  private CommandSettings _settings = new CommandSettings();
  private List<ListItem> _templates = new List<ListItem>();
  private bool _usingAsControl;
  private IContainer components;
  private Button btnCancel;
  private Button btnOK;
  public TabControl optionsTab;
  public TabPage templatesTab;
  ...
  private ColumnHeader templatesName;
  private ColumnHeader templatesID;
  ...
  public ProcessTemplateConfigsForm(CommandSettings commandSettings = null)
  {
  ...
  private void InitFormBySettings(CommandSettings commandSettings)
  {
    ...
    this._templates = commandSettings.Templates;
    this.templatesList.BeginUpdate();
    this.templatesList.Items.Clear();
    foreach (ListItem template in commandSettings.Templates)
    {
      ...
      listViewItem.SubItems.Add(template.ObjID.ToString());
      this.templatesList.Items.Add(listViewItem);
    }
    this.templatesList.EndUpdate();
    ControlHelper.AutoResizeColumns(this.templatesList);
  ...
  private void btnOK_Click(object sender, EventArgs e)
  {
    ...
    commandSettings.CommandType = CommandStatisticsTypesEnum.ProcessTemplate;
    ...
    commandSettings.Activities = this._settings.Activities;
    commandSettings.Templates = new List<ListItem>((IEnumerable<ListItem>) this._templates);
  ...
  private void btnAdd_Click(object sender, EventArgs e)
  {
    ...
    if (schemeChoosingForm.ShowDialog() != DialogResult.OK || schemeChoosingForm.Schemes.Count == 0)
      return;
    foreach (IDBObjectID scheme in schemeChoosingForm.Schemes)
    {
      ListItem listItem = new ListItem(scheme.Caption, scheme.ID, Convert.ToInt64(scheme.Value));
      if (!this._templates.Contains(listItem))
      {
        ListViewItem listViewItem = new ListViewItem()
        {
          Text = scheme.Caption,
        ...
        listViewItem.SubItems.Add(Convert.ToInt64(scheme.Value).ToString());
        this.templatesList.Items.Add(listViewItem);
        this._templates.Add(listItem);
      }
    }
    ControlHelper.AutoResizeColumns(this.templatesList);
    this.Modify();
  ...
  {
    if (!ControlHelper.CanRemoveItems(this.templatesList.SelectedItems.Count, "шаблон", "шаблоны"))
      return;
    for (int index = 0; index < this.templatesList.SelectedItems.Count; index = index - 1 + 1)
    {
      ListViewItem selectedItem = this.templatesList.SelectedItems[index];
      this._templates.Remove(selectedItem.Tag as ListItem);
      this.templatesList.Items.Remove(selectedItem);
    }
    ControlHelper.AutoResizeColumns(this.templatesList);
    this.Modify();
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.templatesName = new ColumnHeader();
    this.templatesID = new ColumnHeader();
    ...
    this.btnCancel.Location = new Point(548, 3);
    ...
    this.btnOK.Location = new Point(451, 3);
    ...
    this.optionsTab.Controls.Add((Control) this.templatesTab);
    this.optionsTab.Location = new Point(5, 178);
    this.optionsTab.Name = "optionsTab";
    this.optionsTab.SelectedIndex = 0;
    this.optionsTab.Size = new Size(634, 331);
    this.optionsTab.TabIndex = 13;
    this.templatesTab.Controls.Add((Control) this.toolBar1);
    this.templatesTab.Controls.Add((Control) this.templatesList);
    this.templatesTab.Location = new Point(4, 22);
    this.templatesTab.Name = "templatesTab";
    this.templatesTab.Padding = new Padding(3);
    this.templatesTab.Size = new Size(626, 305);
    this.templatesTab.TabIndex = 0;
    this.templatesTab.Text = "Анализируемые шаблоны";
    ...
    this.toolBar1.Size = new Size(620, 24);
    ...
    this.templatesList.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
    this.templatesList.Columns.AddRange(new ColumnHeader[2]
    {
      this.templatesName,
      this.templatesID
    });
    ...
    this.templatesList.Location = new Point(0, 27);
    this.templatesList.Name = "templatesList";
    this.templatesList.Size = new Size(626, 277);
    this.templatesList.TabIndex = 7;
    this.templatesList.UseCompatibleStateImageBehavior = false;
    this.templatesList.View = View.Details;
    this.templatesList.SelectedIndexChanged += new EventHandler(this.templatesList_SelectedIndexChanged);
    this.templatesName.Text = "Наименование";
    this.templatesName.Width = 146;
    this.templatesID.Text = "Идентификатор версии объекта";
    this.templatesID.Width = 143;
    ...
    this.groupBox1.Size = new Size(632, 114);
    ...
    this.comboBox1.Size = new Size(443, 21);
    ...
    this.startDate.Size = new Size(353, 20);
    ...
    this.startTime.Location = new Point(542, 10);
    ...
    this.endDate.Size = new Size(353, 20);
    ...
    this.endTime.Location = new Point(540, 47);
    ...
    this.btnPanel.Location = new Point(0, 518);
    this.btnPanel.Name = "btnPanel";
    this.btnPanel.Size = new Size(644, 33);
    this.btnPanel.TabIndex = 16 /*0x10*/;
    ...
    this.Name = nameof (ProcessTemplateConfigsForm);
    this.Text = "Конфигуратор анализатора шаблонов процессов";
