...
// Type: Intermech.Requirement.DeletedObjectRelationWithID
...
public class DeletedObjectRelationWithID
{
  public string DeletedTTName { get; set; }

  public string DeletedTTID { get; set; }
}
