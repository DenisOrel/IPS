...
// Type: Intermech.Requirement.Diff.DiffEngine
...
public class DiffEngine
{
  ...
  {
    int sourceMatchLength = 0;
    while (sourceMatchLength < maxLength && this._dest.GetByIndex(destIndex + sourceMatchLength).CompareTo((object) this._source.GetByIndex(sourceIndex + sourceMatchLength)) == 0)
      ++sourceMatchLength;
    return sourceMatchLength;
  }
