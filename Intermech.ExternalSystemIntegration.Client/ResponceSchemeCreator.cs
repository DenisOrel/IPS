...
// Type: Intermech.ExternalSystemIntegration.Client.ResponceSchemeCreator
...
internal class ResponceSchemeCreator : IObjectCreatorRiderCustomService, IObjectCreatorCustomService
{
  private ResponceSchemeCreatorStepOne ocs1;
  ...
  public Dictionary<UserControl, int> AddPages(object CreatedObject, int propPageIndex)
  {
    ...
    {
      this.ocs1 = new ResponceSchemeCreatorStepOne(createdObject);
