...
// Type: Intermech.ExternalSystemIntegration.Client.ResponceSchemeObjectViewProvider
...
internal class ResponceSchemeObjectViewProvider : IViewsProvider
{
  public ViewsInfo GetViews(ISelectedItems items, IServiceProvider services)
  {
    ...
    views.Add("ResponceSchemePage", new ViewInfo(0, typeof (ResponceSchemeObjectView)));
    return views;
  }
}
