...
// Type: Intermech.ExternalSystemIntegration.Client.ResponceConfigObjectViewProvider
...
internal class ResponceConfigObjectViewProvider : IViewsProvider
{
  public ViewsInfo GetViews(ISelectedItems items, IServiceProvider services)
  {
    ...
    views.Add("ResponceConfigPage", new ViewInfo(0, typeof (ResponceConfigObjectView)));
    return views;
  }
}
