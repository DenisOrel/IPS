...
// Type: Intermech.ExternalSystemIntegration.Client.RequestConfigObjectViewProvider
...
internal class RequestConfigObjectViewProvider : IViewsProvider
{
  public ViewsInfo GetViews(ISelectedItems items, IServiceProvider services)
  {
    ...
    views.Add("RequestConfigPage", new ViewInfo(0, typeof (RequestConfigObjectView)));
    return views;
  }
}
