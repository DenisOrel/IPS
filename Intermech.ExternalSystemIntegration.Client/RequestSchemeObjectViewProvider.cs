...
// Type: Intermech.ExternalSystemIntegration.Client.RequestSchemeObjectViewProvider
...
internal class RequestSchemeObjectViewProvider : IViewsProvider
{
  public ViewsInfo GetViews(ISelectedItems items, IServiceProvider services)
  {
    ...
    views.Add("RequestSchemePage", new ViewInfo(0, typeof (RequestSchemeObjectView)));
    return views;
  }
}
