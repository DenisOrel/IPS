...
// Type: Intermech.ExternalSystemIntegration.Client.ResponceSchemeCreatorStepOne
...
public class ResponceSchemeCreatorStepOne : ObjectCreatorControl
{
  ...
  public ResponceSchemeCreatorStepOne(CreatedObjectItem createdObject)
    : base(createdObject)
  {
    this.InitializeComponent();
    using (SessionKeeper sessionKeeper = new SessionKeeper())
    {
      if (!(sessionKeeper.Session.GetObject(this.CreatedObject.ObjectID, true) is IResponceSchemeObject responceSchemeObject))
        return;
  ...
  {
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (ResponceSchemeCreatorStepOne));
    ...
    this.lblRequestSchemeName.TabIndex = 10;
    ...
    this.responceSchemeTreeView.Size = new Size(570, 328);
    this.responceSchemeTreeView.TabIndex = 13;
    ...
    this.Name = nameof (ResponceSchemeCreatorStepOne);
