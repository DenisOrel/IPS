...
// Type: Intermech.XmlExchange.IpsXml.Converter.ToSAP.IMXML.ParmTypeExtention
...
public static class ParmTypeExtention
{
  public static string ToIMXMLTag(this IMXMLFormat.ParmType target)
  {
