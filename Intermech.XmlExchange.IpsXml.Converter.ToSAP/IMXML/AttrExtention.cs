...
// Type: Intermech.XmlExchange.IpsXml.Converter.ToSAP.IMXML.AttrExtention
...
public static class AttrExtention
{
  public static string ToIMXMLTag(this IMXMLFormat.Attr target)
  {
