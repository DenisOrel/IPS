...
// Type: Intermech.XmlExchange.IpsXml.Provider.Techcard.Format.AttrType
...
public enum AttrType
{
  ...
  [Description("parmtype")] ParmType,
  [Description("value")] Value,
  [Description("elementtype")] ElementType,
  [Description("exp_user")] ExportUser,
  [Description("is_head")] IsHead,
}
