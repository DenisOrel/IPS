...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.IdConfigsSerializer
...
[ConfigSerializer(NodeType.IdConfigs)]
internal class IdConfigsSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<IdConfigs>(serializationService, logger)
{
  protected override void OnSaveAddParams(IdConfigs targetConfig, XElement targetNode)
  {
