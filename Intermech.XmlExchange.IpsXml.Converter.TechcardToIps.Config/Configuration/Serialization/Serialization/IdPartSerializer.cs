...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.IdPartSerializer
...
[ConfigSerializer(NodeType.IdPart)]
internal class IdPartSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<IdPart>(serializationService, logger)
{
  protected override void OnSaveAddParams(IdPart targetConfig, XElement targetNode)
  {
    this.SetAttrValue(targetNode, AttrType.ParentType, targetConfig.ParamType.ToXMLTag());
