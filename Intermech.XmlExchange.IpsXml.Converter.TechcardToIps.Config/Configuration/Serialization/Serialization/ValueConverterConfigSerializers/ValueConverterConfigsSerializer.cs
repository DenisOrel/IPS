...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.ValueConverterConfigSerializers.ValueConverterConfigsSerializer
...
[ConfigSerializer(NodeType.ValueConverterConfigs)]
internal class ValueConverterConfigsSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<ValueConverterConfigs>(serializationService, logger)
{
  protected override void OnSaveAddParams(ValueConverterConfigs targetConfig, XElement targetNode)
  {
