...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.ConstValueConfigsSerializer
...
[ConfigSerializer(NodeType.ConstValueConfigs)]
internal class ConstValueConfigsSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<ConstValueConfigs>(serializationService, logger)
{
  protected override void OnSaveAddParams(ConstValueConfigs targetConfig, XElement targetNode)
  {
