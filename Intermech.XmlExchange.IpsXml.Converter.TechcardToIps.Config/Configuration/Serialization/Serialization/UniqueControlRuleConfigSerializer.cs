...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.UniqueControlRuleConfigSerializer
...
[ConfigSerializer(NodeType.UniqueRuleConfig)]
internal class UniqueControlRuleConfigSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<UniqueControlRuleConfig>(serializationService, logger)
{
  protected override void OnSaveAddParams(UniqueControlRuleConfig targetConfig, XElement targetNode)
  {
    this.SetAttrValue(targetNode, AttrType.Type, targetConfig.Rule.ToXMLTag());
  }
}
