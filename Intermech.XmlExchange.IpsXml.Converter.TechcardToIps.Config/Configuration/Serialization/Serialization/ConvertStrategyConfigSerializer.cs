...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.ConvertStrategyConfigSerializer
...
[ConfigSerializer(NodeType.ConvertStrategyConfig)]
internal class ConvertStrategyConfigSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<ConvertStrategyConfig>(serializationService, logger)
{
  protected override void OnSaveAddParams(ConvertStrategyConfig targetConfig, XElement targetNode)
  {
  }
}
