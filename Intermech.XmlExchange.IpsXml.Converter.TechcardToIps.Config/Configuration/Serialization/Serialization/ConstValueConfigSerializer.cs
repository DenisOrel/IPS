...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.ConstValueConfigSerializer
...
[ConfigSerializer(NodeType.ConstValueConfig)]
internal class ConstValueConfigSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<ConstValueConfig>(serializationService, logger)
{
  protected override void OnSaveAddParams(ConstValueConfig targetConfig, XElement targetNode)
  {
  }
}
