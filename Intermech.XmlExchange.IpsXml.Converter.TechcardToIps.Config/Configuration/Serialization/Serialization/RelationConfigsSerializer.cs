...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.RelationConfigsSerializer
...
[ConfigSerializer(NodeType.RelationConfigs)]
internal class RelationConfigsSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<RelationConfigs>(serializationService, logger)
{
  protected override void OnSaveAddParams(RelationConfigs targetConfig, XElement targetNode)
  {
