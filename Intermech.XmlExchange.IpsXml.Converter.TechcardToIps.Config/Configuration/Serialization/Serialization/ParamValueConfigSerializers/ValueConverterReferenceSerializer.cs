...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.ParamValueConfigSerializers.ValueConverterReferenceSerializer
...
[ConfigSerializer(NodeType.ValueConverterReference)]
internal class ValueConverterReferenceSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<ValueConverterReference>(serializationService, logger)
{
  protected override void OnSaveAddParams(ValueConverterReference targetConfig, XElement targetNode)
  {
