...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization.ConvertStrategyConfigsSerializer
...
[ConfigSerializer(NodeType.ConvertStrategyConfigs)]
internal class ConvertStrategyConfigsSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<ConvertStrategyConfigs>(serializationService, logger)
{
  protected override void OnSaveAddParams(ConvertStrategyConfigs targetConfig, XElement targetNode)
  {
