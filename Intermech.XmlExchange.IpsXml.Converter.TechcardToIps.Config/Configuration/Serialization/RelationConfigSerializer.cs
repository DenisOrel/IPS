...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.RelationConfigSerializer
...
using Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.Serialization.Serialization;
...
[ConfigSerializer(NodeType.RelationConfig)]
internal class RelationConfigSerializer(
  ConfigSerializationService serializationService,
  IpsXmlLogger logger) : BaseConfigSerializer<RelationConfig>(serializationService, logger)
{
  protected override void OnSaveAddParams(RelationConfig targetConfig, XElement targetNode)
  {
  }
}
