...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.Config.Configuration.ConfigTypes.ObjectConfig
...
public class ObjectConfig : BaseConvertableEntityWithParamsConfig
{
  public RelationConfigs RelationConfigs { get; set; }
}
