...
// Type: Intermech.Pdm.Compositions.CompareTree.MemoAttributeComparer
...
internal sealed class MemoAttributeComparer : AttributableAttributeComparer<string>
{
  protected override string GetAttributeValue(IDBAttribute attribute)
  {
