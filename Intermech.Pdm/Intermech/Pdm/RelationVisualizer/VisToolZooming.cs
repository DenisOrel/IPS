...
// Type: Intermech.Pdm.RelationVisualizer.VisToolZooming
...
[Serializable]
public class VisToolZooming(MapView v) : MapToolZooming(v)
{
  ...
  public override void DoRubberBand(Rectangle box)
  {
    ...
    float num = Math.Min((float) size.Width / doc1.Width, (float) size.Height / doc1.Height);
