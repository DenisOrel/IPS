...
// Type: Interop.IMShape.IShapeCom2
...
[Guid("CCE53F89-6091-4066-90F0-3A222C2EE284")]
[TypeLibType(TypeLibTypeFlags.FDual | TypeLibTypeFlags.FNonExtensible | TypeLibTypeFlags.FDispatchable)]
[ComImport]
public interface IShapeCom2 : IShapeCom
{
  [DispId(1)]
  ...
  [DispId(23)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunSearchDialogByModel2([MarshalAs(UnmanagedType.Interface), In] Tesselation pTess, [MarshalAs(UnmanagedType.Interface), In] ShapeItemInfo pInfo, [In] long lParentHWND);

  [DispId(24)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunSearchDialogByConfiguration2([MarshalAs(UnmanagedType.Interface), In] IModelConfiguration2 pConf, [In] long lParentHWND);

  [DispId(25)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunSearchDialogByDoc2([MarshalAs(UnmanagedType.Interface), In] ICADDocument pDoc, [In] long lParentHWND);

  [DispId(26)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunSearchDialogFromCad2([MarshalAs(UnmanagedType.Interface), In] ICADSystem2 pCadSystem, [In] long lParentHWND);

  [DispId(27)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunSearchDialogFromPdm2([MarshalAs(UnmanagedType.BStr), In] string bstrPdmArtID, [In] long lParentHWND, out bool pbIsRegistered);

  [DispId(28)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAddDialogByModel2([MarshalAs(UnmanagedType.Interface), In] Tesselation pTess, [MarshalAs(UnmanagedType.Interface), In] ShapeItemInfo pInfo, [In] long lParentHWND);

  [DispId(29)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAddDialogByConfiguration2([MarshalAs(UnmanagedType.Interface), In] IModelConfiguration2 pConf, [In] long lParentHWND);

  [DispId(30)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAddDialogFromPdm2([MarshalAs(UnmanagedType.BStr), In] string bstrPdmArtID, [In] long lParentHWND);

  [DispId(31 /*0x1F*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAddDialogByDoc2([MarshalAs(UnmanagedType.Interface), In] ICADDocument pDoc, [In] long lParentHWND);

  [DispId(32 /*0x20*/)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAddDialogFromCad2([MarshalAs(UnmanagedType.Interface), In] ICADSystem2 pCadSystem, [In] long lParentHWND);

  [DispId(33)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAddFolderDialog2([ComAliasName("Interop.IMShape.EComCadType"), In] EComCadType eType, [In] long lParentHWND);

  [DispId(34)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAboutDialog2([In] long lParentHWND);

  [DispId(35)]
  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void RunAddPdmModelsDialog2([MarshalAs(UnmanagedType.Interface), In] PdmModelsList pList, [In] long lParentHWND);
}
