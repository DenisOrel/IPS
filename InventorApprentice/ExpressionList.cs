...
// Type: InventorApprentice.ExpressionList
...
[Guid("C13EA1C0-2DD0-4B64-9938-0E4804316912")]
...
public interface ExpressionList : IEnumerable
{
  ...
  [DispId(0)]
  string this[[In] int index] { [DispId(0), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  ...
  void SetExpressionList(
    [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_BSTR), In] ref string[] ExpressionList,
    [In] bool ChangeCurrentValue = false,
    [In] int CurrentValueIndex = -1);
}
