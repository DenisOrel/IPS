...
// Type: InventorApprentice.IRxCurveEvaluator
...
[Guid("5DF8603C-6B16-11D3-B794-0060B0F159EF")]
[ComConversionLoss]
[TypeLibType(16 /*0x10*/)]
[InterfaceType(1)]
[ComImport]
public interface IRxCurveEvaluator
{
  ...
  void GetEndPoints([MarshalAs(UnmanagedType.LPArray, SizeConst = 3), Out] double[] pStartPoint, [MarshalAs(UnmanagedType.LPArray, SizeConst = 3), Out] double[] pEndPoint);
