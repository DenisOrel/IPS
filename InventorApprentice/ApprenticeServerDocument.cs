...
// Type: InventorApprentice.ApprenticeServerDocument
...
[Guid("C343ED83-A129-11D3-B799-0060B0F159EF")]
[DefaultMember("Type")]
...
public interface ApprenticeServerDocument
{
  ...
  [DispId(50340628)]
  RenderStyle ActiveRenderStyle { [TypeLibFunc(64 /*0x40*/), DispId(50340628), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [DispId(50340656)]
  string RedirectionInfo { [DispId(50340656), TypeLibFunc(64 /*0x40*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(50340656), TypeLibFunc(64 /*0x40*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }
  ...
  [DispId(50340760)]
  ApprenticeServerDocuments AllReferencedFiles { [DispId(50340760), TypeLibFunc(64 /*0x40*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  [DispId(50340639)]
  HighlightSets HighlightSets { [DispId(50340639), TypeLibFunc(64 /*0x40*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
