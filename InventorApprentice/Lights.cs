...
// Type: InventorApprentice.Lights
...
[Guid("9F512CF6-D755-4539-A0A5-E346F4B89AE1")]
[InterfaceType(2)]
...
public interface Lights : IEnumerable
{
  ...
  [DispId(0)]
  Light this[[MarshalAs(UnmanagedType.Struct), In] object index] { [DispId(0), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
