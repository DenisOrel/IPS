...
// Type: InventorApprentice.RenderStyles
...
[Guid("1F76C4FA-DB71-4D87-8390-1529297ED5A9")]
[TypeLibType(4112)]
[InterfaceType(2)]
[ComImport]
public interface RenderStyles : IEnumerable
{
  ...
  [DispId(0)]
  RenderStyle this[[MarshalAs(UnmanagedType.Struct), In] object index] { [DispId(0), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  RenderStyle Add([MarshalAs(UnmanagedType.BStr), In] string Name);
