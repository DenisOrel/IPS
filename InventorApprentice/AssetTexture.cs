...
// Type: InventorApprentice.AssetTexture
...
[InterfaceType(2)]
[Guid("3E0ED07A-F5ED-46BF-8903-EBC1B409A270")]
...
public interface AssetTexture : IEnumerable
{
  ...
  [DispId(50452481)]
  AssetTextureTypeEnum TextureType { [DispId(50452481), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

  [DispId(50452482)]
  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
  void ChangeTextureType([In] AssetTextureTypeEnum TextureType, [MarshalAs(UnmanagedType.Struct), In, Optional] object ImageFilename);
}
