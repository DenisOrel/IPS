...
// Type: InventorApprentice.StringAssetValue
...
[InterfaceType(2)]
[Guid("9ADC4649-06DC-449E-ABE8-5DCA6F4C7788")]
[ComImport]
public interface StringAssetValue
{
  ...
  [DispId(50451713)]
  string Value { [DispId(50451713), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(50451713), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; }
}
