...
// Type: InventorApprentice.TableParameter
...
[InterfaceType(2)]
[DefaultMember("Type")]
[Guid("B1F0562A-BC71-44E3-89B6-5583BB50CD09")]
[ComImport]
public interface TableParameter
{
  ...
  [DispId(50346769)]
  bool Visible { [DispId(50346769), TypeLibFunc(64 /*0x40*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [TypeLibFunc(64 /*0x40*/), DispId(50346769), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
