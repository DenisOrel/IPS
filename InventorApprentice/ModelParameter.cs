...
// Type: InventorApprentice.ModelParameter
...
[Guid("916D7FDB-CFE6-4FB1-8921-694DC9CD2793")]
[InterfaceType(2)]
[DefaultMember("Type")]
[ComImport]
public interface ModelParameter
{
  ...
  [DispId(50348549)]
  bool BuiltIn { [DispId(50348549), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  ...
  [DispId(50348551)]
  bool Renamed { [DispId(50348551), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
}
