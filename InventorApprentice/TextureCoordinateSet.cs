...
// Type: InventorApprentice.TextureCoordinateSet
...
[InterfaceType(2)]
[Guid("D96060F8-0E08-4E73-8D5E-37F506A1A738")]
...
public interface TextureCoordinateSet
{
  ...
  [DispId(0)]
  Point this[[In] int index] { [DispId(0), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  ...
  void GetCoordinates([MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_R8)] out double[] Coordinates);
}
