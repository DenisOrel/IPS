...
// Type: InventorApprentice.VertexProxy
...
[DefaultMember("Type")]
[InterfaceType(2)]
[Guid("46AEA730-4302-11D4-B7AB-0060B0F159EF")]
[ComImport]
public interface VertexProxy
{
  ...
  [DispId(67120438)]
  int AssociativeID { [DispId(67120438), TypeLibFunc(64 /*0x40*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(67120438), TypeLibFunc(64 /*0x40*/), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

  [DispId(67114033)]
  Vertex NativeObject { [DispId(67114033), MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
