...
// Type: Intermech.Serialization.ClassicFormatters.ObjectManager
...
{
  private const int DefaultInitialSize = 16 /*0x10*/;
  private const int MaxArraySize = 1048576 /*0x100000*/;
  private const int ArrayMask = 1048575 /*0x0FFFFF*/;
  ...
  {
    this._objects = new ObjectHolder[16 /*0x10*/];
  ...
  {
    int index = (int) (objectID & 1048575L /*0x0FFFFF*/);
  ...
  {
    if (holder._id >= (long) this._objects.Length && this._objects.Length != 1048576 /*0x100000*/)
    {
      int length = 1048576 /*0x100000*/;
      if (holder._id < 524288L /*0x080000*/)
      {
        length = this._objects.Length * 2;
        while ((long) length <= holder._id && length < 1048576 /*0x100000*/)
          length *= 2;
        if (length > 1048576 /*0x100000*/)
          length = 1048576 /*0x100000*/;
      }
    ...
    int index = (int) (holder._id & 1048575L /*0x0FFFFF*/);
    ...
    bool bThrowIfMissing)
  {
    ...
    if (holder == null || holder.CanObjectValueChange || holder.ObjectValue == null)
    {
      if (!bThrowIfMissing)
        return false;
      if (holder == null)
        throw new SerializationException(SR.Format(SR2.Serialization_NeverSeen, (object) fixup._id));
      if (holder.IsIncompleteObjectReference)
        throw new SerializationException(SR.Format(SR2.Serialization_IORIncomplete, (object) fixup._id));
      throw new SerializationException(SR.Format(SR2.Serialization_ObjectNotSupplied, (object) fixup._id));
    }
    ...
    if (holder.HasSurrogate)
    {
      ...
      if (obj != null)
      {
        if (!holder.CanSurrogatedObjectValueChange && obj != holder.ObjectValue)
          throw new SerializationException(SR.Format(SR2.Serialization_NotCyclicallyReferenceableSurrogate, (object) surrogate.GetType().FullName));
  ...
  private bool ResolveObjectReference(ObjectHolder holder)
  {
    ...
    try
    {
      ...
      do
      {
        ...
        if (num++ == 100)
          throw new SerializationException(SR2.Serialization_TooManyReferences);
  ...
  private bool DoValueTypeFixup(FieldInfo memberToFix, ObjectHolder holder, object value)
  {
    ...
    while (holder.RequiresValueTypeFixup)
    {
      ...
      if (valueFixup.ParentField != (FieldInfo) null)
      {
        ...
        if (objectHolder.ObjectValue != null)
        {
          ...
          {
            sourceArray[length] = parentField.FieldType.GetField(nameof (value), BindingFlags.Instance | BindingFlags.NonPublic);
            ++length;
          }
    ...
    if (length != 0)
    {
      ...
      for (int index = 0; index < length; ++index)
      {
        ...
        flds[index] = (FieldInfo) serializationFieldInfo == (FieldInfo) null ? fieldInfo : serializationFieldInfo.FieldInfo;
      }
  ...
  internal void CompleteObject(ObjectHolder holder, bool bObjectFullyComplete)
  {
    ...
    int num = 0;
    if (holder.ObjectValue == null)
      throw new SerializationException(SR.Format(SR2.Serialization_MissingObject, (object) holder._id));
    ...
    if (holder.HasSurrogate || holder.HasISerializable)
    {
      ...
      if (serInfo == null)
        throw new SerializationException(SR2.Serialization_InvalidFixupDiscovered);
      if (missingElements != null)
      {
      ...
      for (int index = 0; index < missingElements._count; ++index)
      {
        ...
        if (fixup != null && this.GetCompletionInfo(fixup, out holder1, out member, bObjectFullyComplete))
        {
          if (holder1.TypeLoadExceptionReachable)
          {
            ...
            if (holder.Reachable)
              throw new SerializationException(SR.Format(SR2.Serialization_TypeLoadFailure, (object) holder.TypeLoadException.TypeName));
          }
          if (holder.Reachable)
          ...
          switch (fixup._fixupType)
          {
            case 1:
              if (holder.RequiresValueTypeFixup)
                throw new SerializationException(SR2.Serialization_ValueTypeFixup);
            ...
            case 2:
              ...
              if ((object) (memberInfo as FieldInfo) == null)
                throw new SerializationException(SR2.Serialization_UnableToFixup);
              if (holder.RequiresValueTypeFixup && holder.ValueTypeFixupPerformed)
              {
                if (!this.DoValueTypeFixup((FieldInfo) memberInfo, holder, holder1.ObjectValue))
                  throw new SerializationException(SR2.Serialization_PartialValueTypeFixup);
              }
              else
  ...
  {
    ObjectHolder objectHolder = objectID > 0L ? this.FindObjectHolder(objectID) : throw new ArgumentOutOfRangeException(nameof (objectID), SR2.ArgumentOutOfRange_ObjectID);
    ...
    int[] arrayIndex)
  {
    ...
    if (objectID <= 0L)
      throw new ArgumentOutOfRangeException(nameof (objectID), SR2.ArgumentOutOfRange_ObjectID);
    if (member != (MemberInfo) null && (object) (member as FieldInfo) == null)
      throw new SerializationException(SR2.Serialization_UnknownMemberInfo);
    ISerializationSurrogate surrogate = (ISerializationSurrogate) null;
    if (this._selector != null)
      surrogate = this._selector.GetSurrogate(this.CanCallGetType(obj) ? obj.GetType() : typeof (MarshalByRefObject), this._context, out ISurrogateSelector _);
    ...
    {
      if (objectHolder.ObjectValue != null)
        throw new SerializationException(SR2.Serialization_RegisterTwice);
    ...
    StreamingContext context)
  {
    if (obj == null)
      throw new ArgumentNullException(nameof (obj));
    Type type = obj is ISerializable ? obj.GetType() : throw new ArgumentException(SR2.Serialization_NotISer);
    ...
    {
      throw new SerializationException(SR.Format(SR2.Serialization_ConstructorNotFound, (object) type), ex);
    }
    deserializationConstructor.Invoke(obj, new object[2]
    {
      (object) info,
      (object) context
    });
  ...
  {
    foreach (ConstructorInfo constructor in t.GetConstructors(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic))
    {
    ...
    throw new SerializationException(SR.Format(SR2.Serialization_ConstructorNotFound, (object) t.FullName));
  }
  ...
  public virtual void DoFixups()
  {
    ...
    while (num != 0)
    {
      ...
      while (fixupEnumerator.MoveNext())
      {
        ...
        if (current.ObjectValue == null)
          throw new SerializationException(SR.Format(SR2.Serialization_ObjectNotSupplied, (object) current._id));
    ...
    if (this._fixupCount == 0L)
    {
      if (this.TopObject is TypeLoadExceptionHolder)
        throw new SerializationException(SR.Format(SR2.Serialization_TypeLoadFailure, (object) ((TypeLoadExceptionHolder) this.TopObject).TypeName));
    }
    else
    {
      ...
      throw new SerializationException(SR2.Serialization_IncorrectNumberOfFixups);
    }
  }
  ...
  private void RegisterFixup(FixupHolder fixup, long objectToBeFixed, long objectRequired)
  {
    ...
    if (createObjectHolder.RequiresSerInfoFixup && fixup._fixupType == 2)
      throw new SerializationException(SR2.Serialization_InvalidFixupType);
  ...
  public virtual void RecordFixup(long objectToBeFixed, MemberInfo member, long objectRequired)
  {
    if (objectToBeFixed <= 0L || objectRequired <= 0L)
      throw new ArgumentOutOfRangeException(objectToBeFixed <= 0L ? nameof (objectToBeFixed) : nameof (objectRequired), SR2.Serialization_IdTooSmall);
    if (member == (MemberInfo) null)
      throw new ArgumentNullException(nameof (member));
    if ((object) (member as FieldInfo) == null)
      throw new SerializationException(SR.Format(SR2.Serialization_InvalidType, (object) member.GetType()));
    ...
    long objectRequired)
  {
    if (arrayToBeFixed <= 0L || objectRequired <= 0L)
      throw new ArgumentOutOfRangeException(arrayToBeFixed <= 0L ? nameof (arrayToBeFixed) : nameof (objectRequired), SR2.Serialization_IdTooSmall);
    if (indices == null)
