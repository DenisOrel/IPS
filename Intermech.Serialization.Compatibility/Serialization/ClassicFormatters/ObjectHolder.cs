...
// Type: Intermech.Serialization.ClassicFormatters.ObjectHolder
...
internal sealed class ObjectHolder
{
  ...
  internal const int SER_INFO_FIXED = 16384 /*0x4000*/;
  internal const int VALUETYPE_FIXUP_PERFORMED = 32768 /*0x8000*/;
    ...
    int[] arrayIndex)
  {
    ...
    if (idOfContainingObj != 0L && (field != (FieldInfo) null && field.FieldType.IsValueType || arrayIndex != null))
    {
      if (idOfContainingObj == objID)
        throw new SerializationException(SR2.Serialization_ParentChildIdentical);
  ...
  internal bool RequiresSerInfoFixup
  {
    get
    {
      return ((this._flags & 4) != 0 || (this._flags & 2) != 0) && (this._flags & 16384 /*0x4000*/) == 0;
    }
    set
    {
      if (!value)
        this._flags |= 16384 /*0x4000*/;
      else
        this._flags &= -16385;
    }
  }
  ...
  internal bool CompletelyFixed => !this.RequiresSerInfoFixup && !this.IsIncompleteObjectReference;
