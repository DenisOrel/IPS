...
// Type: Intermech.Serialization.ClassicFormatters.Binary.ObjectMap
...
internal sealed class ObjectMap
{
    ...
    SizedArray assemIdToAssemblyTable)
  {
    ...
    if (assemblyInfo == null)
      throw new SerializationException(SR.Format(SR2.Serialization_Assembly, (object) objectName));
