...
// Type: Intermech.Serialization.ClassicFormatters.Binary.BinaryParser
...
internal sealed class BinaryParser
{
  ...
  private const int ChunkSize = 4096 /*0x1000*/;
  ...
  internal void Run()
  {
          ...
          case BinaryTypeEnum.PrimitiveArray:
            ...
            switch (binaryHeaderEnum)
            {
              ...
              case BinaryHeaderEnum.CrossAppDomainMap:
                ...
                break;
              default:
                throw new SerializationException(SR.Format(SR2.Serialization_BinaryHeader, (object) p1));
            }
            break;
          default:
            throw new SerializationException(SR2.Serialization_TypeExpected);
        }
    ...
    {
      throw new SerializationException(SR2.Serialization_StreamEnd);
    }
  }
  ...
  internal void ReadBytes(byte[] byteA, int offset, int size)
  {
    ...
    for (; size > 0; size -= num)
    {
      ...
      if (num == 0)
        throw new EndOfStreamException(SR2.IO_EOF_ReadBeyondEOF);
      offset += num;
    }
  }
  ...
  {
    DateTime dateTime = new DateTime(dateData & 4611686018427387903L /*0x3FFFFFFFFFFFFFFF*/);
    return new DateTimeRaw() { LongValue = dateData }.DateTimeValue;
  }
  ...
  internal void ReadAssembly(BinaryHeaderEnum binaryHeaderEnum)
  {
    ...
    if (binaryHeaderEnum == BinaryHeaderEnum.CrossAppDomainAssembly)
    {
      ...
      if (binaryAssembly._assemblyString == null)
        throw new SerializationException(SR.Format(SR2.Serialization_CrossAppDomainError, (object) "String", (object) appDomainAssembly._assemblyIndex));
    }
    else
  ...
  private void ReadObject()
  {
    ...
    if (objectMap == null)
      throw new SerializationException(SR.Format(SR2.Serialization_Map, (object) this._binaryObject._mapId));
    ...
    else
    {
      ...
      switch (objectProgress._objectTypeEnum)
      {
        ...
        case InternalObjectTypeE.Array:
          ...
          break;
        default:
          throw new SerializationException(SR.Format(SR2.Serialization_Map, (object) objectProgress._objectTypeEnum.ToString()));
      }
    }
  ...
  internal void ReadCrossAppDomainMap()
  {
    ...
    switch (p2)
    {
      ...
      case BinaryObjectWithMapTyped record2:
        ...
        break;
      default:
        throw new SerializationException(SR.Format(SR2.Serialization_CrossAppDomainError, (object) "BinaryObjectMap", p2));
    }
  }
  ...
  private void ReadObjectWithMap(BinaryObjectWithMap record)
  {
    ...
    if (record._binaryHeaderEnum == BinaryHeaderEnum.ObjectWithMapAssemId)
    {
      if (record._assemId < 1)
        throw new SerializationException(SR.Format(SR2.Serialization_Assembly, (object) record._name));
      assemblyInfo = (BinaryAssemblyInfo) this.AssemIdToAssemblyTable[record._assemId];
      if (assemblyInfo == null)
        throw new SerializationException(SR.Format(SR2.Serialization_Assembly, (object) $"{record._assemId.ToString()} {record._name}"));
    }
    ...
    else
    {
      ...
      switch (objectProgress._objectTypeEnum)
      {
        ...
        case InternalObjectTypeE.Array:
          ...
          break;
        default:
          throw new SerializationException(SR.Format(SR2.Serialization_ObjectTypeEnum, (object) objectProgress._objectTypeEnum.ToString()));
      }
    }
    pr._objectTypeEnum = InternalObjectTypeE.Object;
  ...
  private void ReadObjectWithMapTyped(BinaryObjectWithMapTyped record)
  {
    ...
    {
      if (record._assemId < 1)
        throw new SerializationException(SR.Format(SR2.Serialization_AssemblyId, (object) record._name));
      assemblyInfo = (BinaryAssemblyInfo) this.AssemIdToAssemblyTable[record._assemId];
      if (assemblyInfo == null)
        throw new SerializationException(SR.Format(SR2.Serialization_AssemblyId, (object) $"{record._assemId.ToString()} {record._name}"));
    }
  ...
  private void ReadObjectString(BinaryHeaderEnum binaryHeaderEnum)
  {
    ...
    else
    {
      ...
      if (this._objectString._value == null)
        throw new SerializationException(SR.Format(SR2.Serialization_CrossAppDomainError, (object) "String", (object) this._crossAppDomainString._value));
  ...
  private void ReadArray(BinaryHeaderEnum binaryHeaderEnum)
  {
    ...
    if (binaryArray._binaryTypeEnum == BinaryTypeEnum.ObjectUser)
    {
      if (binaryArray._assemId < 1)
        throw new SerializationException(SR.Format(SR2.Serialization_AssemblyId, binaryArray._typeInformation));
    ...
    switch (binaryArray._binaryArrayTypeEnum)
    {
      ...
      case BinaryArrayTypeEnum.RectangularOffset:
        ...
        break;
      default:
        throw new SerializationException(SR.Format(SR2.Serialization_ArrayType, (object) binaryArray._binaryArrayTypeEnum.ToString()));
    }
    if (!flag)
      this._stack.Push((object) op);
    else
  ...
  private void ReadArrayAsBytes(ParseRecord pr)
  {
    ...
    else
    {
      ...
      if (this._byteBuffer == null)
        this._byteBuffer = new byte[4096 /*0x1000*/];
      int num3;
      for (; num2 < newObj.Length; num2 += num3)
      {
        num3 = Math.Min(4096 /*0x1000*/ / num1, newObj.Length - num2);
        int num4 = num3 * num1;
  ...
  internal object ReadValue(InternalPrimitiveTypeE code)
  {
    switch (code)
    {
      ...
      default:
        throw new SerializationException(SR.Format(SR2.Serialization_TypeCode, (object) code.ToString()));
    }
  }
