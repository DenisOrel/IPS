...
// Type: Intermech.Serialization.ClassicFormatters.Binary.BinaryTypeConverter
...
internal static class BinaryTypeConverter
{
    ...
    else
    {
      ...
      if (code == InternalPrimitiveTypeE.Invalid)
      {
        ...
        else
        {
          ...
          if (assemId == 0)
            throw new SerializationException(SR.Format(SR2.Serialization_AssemblyId, typeInformation));
        }
      }
      else
      {
  ...
  internal static BinaryTypeEnum GetParserBinaryTypeInfo(Type type, out object typeInformation)
  {
    ...
    else
    {
      ...
      if (code == InternalPrimitiveTypeE.Invalid)
      {
        parserBinaryTypeInfo = type.Assembly == Converter.s_urtAssembly ? BinaryTypeEnum.ObjectUrt : BinaryTypeEnum.ObjectUser;
        typeInformation = (object) type.FullName;
      }
      else
      {
    ...
    BinaryFormatterWriter output)
  {
    switch (binaryTypeEnum)
    {
      ...
      case BinaryTypeEnum.StringArray:
        break;
      default:
        throw new SerializationException(SR.Format(SR2.Serialization_TypeWrite, (object) binaryTypeEnum.ToString()));
    }
  }
    ...
    out int assemId)
  {
    ...
    switch (binaryTypeEnum)
    {
      ...
      case BinaryTypeEnum.ObjectUser:
        ...
        goto case BinaryTypeEnum.String;
      default:
        throw new SerializationException(SR.Format(SR2.Serialization_TypeRead, (object) binaryTypeEnum.ToString()));
    }
  }
