...
// Type: Intermech.Serialization.ClassicFormatters.Binary.ObjectWriter
...
internal sealed class ObjectWriter
{
  ...
  private Intermech.Serialization.ClassicFormatters.ObjectIDGenerator _idGenerator;
  private int _currentId;
  private readonly ISurrogateSelector _surrogates;
  private readonly StreamingContext _context;
  private BinaryFormatterWriter _serWriter;
  private readonly Intermech.Serialization.ClassicFormatters.SerializationObjectManager _objectManager;
  private long _topId;
    ...
    SerializationBinder binder)
  {
    ...
    this._objectManager = new Intermech.Serialization.ClassicFormatters.SerializationObjectManager(context);
  }
  ...
  internal void Serialize(object graph, BinaryFormatterWriter serWriter)
  {
    ...
    this._idGenerator = new Intermech.Serialization.ClassicFormatters.ObjectIDGenerator();
  ...
  internal Intermech.Serialization.ClassicFormatters.SerializationObjectManager ObjectManager
  {
  ...
  private void Write(WriteObjectInfo objectInfo, NameInfo memberNameInfo, NameInfo typeNameInfo)
  {
    ...
    Type typeofString = Converter.s_typeofString;
    if ((object) objectType == (object) typeofString)
    {
    ...
    WriteObjectInfo memberObjectInfo)
  {
    ...
    {
      objectInfo1 = WriteObjectInfo.Serialize(elementType, this._surrogates, this._context, this._serObjectInfoInit, this._formatterConverter, this._binder);
  ...
  private object GetNext(out long objID)
  {
    ...
    if (firstTime)
      throw new SerializationException(SR.Format(SR2.Serialization_ObjNoID, p1));
    return next;
  }
    ...
    out bool isNew)
  {
    ...
    if (type != (Type) null && type.IsValueType && !assignUniqueIdToValueType)
    {
      isNew = false;
  ...
  private bool CheckForNull(
    ...
    object data)
  {
    int num = data == null ? 1 : 0;
    if (num == 0)
      return num != 0;
    if (this._formatterEnums._serializerTypeEnum != InternalSerializerTypeE.Binary && !memberNameInfo._isArrayItem && !memberNameInfo._transmitTypeOnObject && !memberNameInfo._transmitTypeOnMember && !objectInfo._isSi && !this.CheckTypeFormat(this._formatterEnums._typeFormat, FormatterTypeStyle.TypesAlways))
      return num != 0;
