...
// Type: Intermech.Serialization.ClassicFormatters.Binary.ReadObjectInfo
...
internal sealed class ReadObjectInfo
{
  ...
  internal static ReadObjectInfo Create(
    ...
    Intermech.Serialization.ClassicFormatters.ObjectManager objectManager,
  ...
  internal MemberInfo GetMemberInfo(string name)
  {
    ...
    if (this._isSi)
      throw new SerializationException(SR.Format(SR2.Serialization_MemberInfo, (object) $"{this._objectType?.ToString()} {name}"));
    if (this._cache._memberInfos == null)
      throw new SerializationException(SR.Format(SR2.Serialization_NoMemberInfo, (object) $"{this._objectType?.ToString()} {name}"));
  ...
  internal Type GetType(string name)
  {
    ...
    return !(type == (Type) null) ? type : throw new SerializationException(SR.Format(SR2.Serialization_ISerializableTypes, (object) $"{this._objectType?.ToString()} {name}"));
  }
  ...
  internal void PopulateObjectMembers(object obj, object[] memberData)
  {
    if (this._isSi || memberData == null)
      return;
    Intermech.Serialization.ClassicFormatters.FormatterServices.PopulateObjectMembers(obj, this._cache._memberInfos, memberData);
  }
  ...
  {
    if (this._isSi)
      throw new SerializationException(SR.Format(SR2.Serialization_ISerializableTypes, (object) objectType));
    if (this._cache == null)
      return (Type[]) null;
    ...
    for (int index1 = 0; index1 < this._cache._memberInfos.Length; ++index1)
    {
      ...
      else
      {
        ...
        if (!flag2 && !this._isSimpleAssembly && this._cache._memberInfos[index1].GetCustomAttribute(typeof (OptionalFieldAttribute), false) == null)
          throw new SerializationException(SR.Format(SR2.Serialization_MissingMember, (object) this._cache._memberNames[index1], (object) objectType, (object) typeof (OptionalFieldAttribute).FullName));
      }
    }
    return memberTypes;
  }
  ...
  {
    return (object) (objMember as FieldInfo) != null ? ((FieldInfo) objMember).FieldType : throw new SerializationException(SR.Format(SR2.Serialization_SerMemberInfo, (object) objMember.GetType()));
  }
