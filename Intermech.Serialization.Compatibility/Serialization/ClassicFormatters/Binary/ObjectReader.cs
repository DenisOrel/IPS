...
// Type: Intermech.Serialization.ClassicFormatters.Binary.ObjectReader
...
internal sealed class ObjectReader
{
  ...
  internal Intermech.Serialization.ClassicFormatters.ObjectManager _objectManager;
  ...
  private const int ThresholdForValueTypeIds = 2147483647 /*0x7FFFFFFF*/;
  ...
  {
    get => this._valueFixupStack ?? (this._valueFixupStack = new SerStack("ValueType Fixup Stack"));
  }
  ...
  internal object Deserialize(BinaryParser serParser)
  {
    ...
    {
      this._objectManager = new Intermech.Serialization.ClassicFormatters.ObjectManager(this._surrogates, this._context);
    ...
    if (this.TopObject == null)
      throw new SerializationException(SR2.Serialization_TopObject);
  ...
  private void CheckSerializable(Type t)
  {
    if (!t.IsSerializable && !this.HasSurrogate(t))
      throw new SerializationException(SR.Format((IFormatProvider) CultureInfo.InvariantCulture, SR2.Serialization_NonSerType, (object) t.FullName, (object) t.Assembly.FullName));
  }
  ...
  {
    return ReadObjectInfo.Create(objectType, this._surrogates, this._context, this._objectManager, this._serObjectInfoInit, this._formatterConverter, this._isSimpleAssembly);
  }
  ...
  internal ReadObjectInfo CreateReadObjectInfo(
    ...
    Type[] memberTypes)
  {
    return ReadObjectInfo.Create(objectType, memberNames, memberTypes, this._surrogates, this._context, this._objectManager, this._serObjectInfoInit, this._formatterConverter, this._isSimpleAssembly);
  }
  ...
  internal void Parse(ParseRecord pr)
  {
    switch (pr._parseTypeEnum)
    {
      ...
      case InternalParseTypeE.BodyEnd:
        break;
      default:
        throw new SerializationException(SR.Format(SR2.Serialization_XMLElement, (object) pr._name));
    }
  }

  private void ParseError(ParseRecord processing, ParseRecord onStack)
  {
    throw new SerializationException(SR.Format(SR2.Serialization_ParseError, (object) $"{onStack._name} {onStack._parseTypeEnum.ToString()} {processing._name} {processing._parseTypeEnum.ToString()}"));
  }
  ...
  private void ParseObject(ParseRecord pr)
  {
    ...
    else
    {
      ...
      pr._newObj = Intermech.Serialization.ClassicFormatters.FormatterServices.GetUninitializedObject(pr._dtType);
      this._objectManager.RaiseOnDeserializingEvent(pr._newObj);
      if (pr._newObj == null)
        throw new SerializationException(SR.Format(SR2.Serialization_TopObjectInstantiate, (object) pr._dtType));
      if (pr._objectPositionEnum == InternalObjectPositionE.Top)
        this.TopObject = pr._newObj;
      if (pr._objectInfo != null)
        return;
      pr._objectInfo = ReadObjectInfo.Create(pr._dtType, this._surrogates, this._context, this._objectManager, this._serObjectInfoInit, this._formatterConverter, this._isSimpleAssembly);
    }
  }
  ...
  private void ParseObjectEnd(ParseRecord pr)
  {
    ...
    if (parseRecord1._objectPositionEnum == InternalObjectPositionE.Top && (object) parseRecord1._dtType == (object) Converter.s_typeofString)
    {
  ...
  private void ParseArray(ParseRecord pr)
  {
    ...
    else if (pr._arrayTypeEnum == InternalArrayTypeE.Jagged || pr._arrayTypeEnum == InternalArrayTypeE.Single)
    {
      ...
      if (pr._arrayTypeEnum == InternalArrayTypeE.Single)
      {
        ...
        else if (flag && pr._arrayElementType != (Type) null && !pr._arrayElementType.IsValueType && !pr._isLowerBound)
    ...
    else
    {
      if (pr._arrayTypeEnum != InternalArrayTypeE.Rectangular)
        throw new SerializationException(SR.Format(SR2.Serialization_ArrayType, (object) pr._arrayTypeEnum));
      pr._isLowerBound = false;
      ...
      if (pr._arrayElementType != (Type) null)
        pr._newObj = !pr._isLowerBound ? (object) Array.CreateInstance(pr._arrayElementType, pr._lengthA) : (object) Array.CreateInstance(pr._arrayElementType, pr._lengthA, pr._lowerBoundA);
      int num = 1;
      for (int index = 0; index < pr._rank; ++index)
  ...
  private void NextRectangleMap(ParseRecord pr)
  {
    for (int index1 = pr._rank - 1; index1 > -1; --index1)
    {
      if (pr._rectangularMap[index1] < pr._lengthA[index1] - 1)
      {
        ...
        Array.Copy((Array) pr._rectangularMap, (Array) pr._indexMap, pr._rank);
        break;
      }
    }
  }
  ...
  private void ParseArrayMember(ParseRecord pr)
  {
    ...
    if (pr._memberValueEnum == InternalMemberValueE.Reference)
    {
      ...
      if (obj == null)
      {
        ...
        Array.Copy((Array) parseRecord._indexMap, (Array) numArray, parseRecord._rank);
    ...
    {
      if ((object) parseRecord._arrayElementType == (object) Converter.s_typeofString || (object) pr._dtType == (object) Converter.s_typeofString)
      {
      ...
      {
        if (pr._keyDt == null)
          throw new SerializationException(SR2.Serialization_ArrayTypeObject);
        object obj;
      ...
      {
        object obj = pr._varValue != null ? pr._varValue : Converter.FromString(pr._value, parseRecord._arrayElementTypeCode);
        if (parseRecord._objectA != null)
          parseRecord._objectA[parseRecord._indexMap[0]] = obj;
        else
          ((Array) parseRecord._newObj).SetValue(obj, parseRecord._indexMap);
  ...
  private void ParseMember(ParseRecord pr)
  {
    ...
    switch (pr._memberTypeEnum)
    {
      ...
      default:
        ...
        {
          parseRecord._objectInfo.AddValue(pr._name, (object) null, ref parseRecord._si, ref parseRecord._memberData);
          break;
        }
        if (pr._memberValueEnum == InternalMemberValueE.Nested)
        {
          this.ParseObject(pr);
          this._stack.Push((object) pr);
          if (pr._objectInfo != null && pr._objectInfo._objectType != (Type) null && pr._objectInfo._objectType.IsValueType)
          {
            pr._isValueTypeFixup = true;
        ...
        if (pr._memberValueEnum == InternalMemberValueE.InlineValue)
        {
          ...
          {
            this.ParseString(pr, parseRecord);
            parseRecord._objectInfo.AddValue(pr._name, (object) pr._value, ref parseRecord._si, ref parseRecord._memberData);
            break;
          }
          if (pr._dtTypeCode == InternalPrimitiveTypeE.Invalid)
          {
            if (pr._arrayTypeEnum == InternalArrayTypeE.Base64)
            {
              parseRecord._objectInfo.AddValue(pr._name, (object) Convert.FromBase64String(pr._value), ref parseRecord._si, ref parseRecord._memberData);
              break;
            }
            if ((object) pr._dtType == (object) Converter.s_typeofObject)
              throw new SerializationException(SR.Format(SR2.Serialization_TypeMissing, (object) pr._name));
            this.ParseString(pr, parseRecord);
            if ((object) pr._dtType == (object) Converter.s_typeofSystemVoid)
            {
              parseRecord._objectInfo.AddValue(pr._name, (object) pr._dtType, ref parseRecord._si, ref parseRecord._memberData);
              break;
            }
  ...
  internal Type FastBindToType(string assemblyName, string typeName)
  {
    ...
    if (typeNassembly == null || typeNassembly.AssemblyName != assemblyName)
    {
      ...
      if (this._isSimpleAssembly)
        ...
        type = Intermech.Serialization.ClassicFormatters.FormatterServices.GetTypeFromAssembly(assembly, typeName);
      if (type == (Type) null)
        return (Type) null;
  ...
  private static void GetSimplyNamedTypeFromAssembly(Assembly assm, string typeName, ref Type type)
  {
    try
    {
      type = Intermech.Serialization.ClassicFormatters.FormatterServices.GetTypeFromAssembly(assm, typeName);
    }
  ...
  {
    Type type;
    if (this._previousName != null && this._previousName.Length == name.Length && this._previousName.Equals(name) && this._previousAssemblyString != null && this._previousAssemblyString.Length == assemblyInfo._assemblyString.Length && this._previousAssemblyString.Equals(assemblyInfo._assemblyString))
    {
    ...
    else
    {
      ...
      if (type == (Type) null)
      {
        ...
        if (this._isSimpleAssembly)
          ...
          type = Intermech.Serialization.ClassicFormatters.FormatterServices.GetTypeFromAssembly(assembly, name);
        if (type != (Type) null)
          ObjectReader.CheckTypeForwardedTo(assembly, type.Assembly, type);
      }
