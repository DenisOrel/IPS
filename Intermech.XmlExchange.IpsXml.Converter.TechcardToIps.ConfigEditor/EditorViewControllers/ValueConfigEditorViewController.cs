...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.ConfigEditor.EditorViewControllers.ValueConfigEditorViewController
...
internal class ValueConfigEditorViewController(IServiceProvider services) : BaseEditorViewController(services)
{
  private ValueConfigEditorView editorView = new ValueConfigEditorView();
  ...
  protected override void OnBeforeShowEditorConfig()
  {
    ...
    this.editorView.TargetConfig = this.TargetConfig as ValueConfig;
