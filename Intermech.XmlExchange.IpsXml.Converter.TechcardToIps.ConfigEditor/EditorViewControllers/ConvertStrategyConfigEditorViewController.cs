...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.ConfigEditor.EditorViewControllers.ConvertStrategyConfigEditorViewController
...
[ConfigNodeType(NodeType.ConvertStrategyConfig)]
internal class ConvertStrategyConfigEditorViewController(IServiceProvider services) : 
  BaseEditorViewController(services)
{
  private ConvertStrategyConfigEditorView editorView = new ConvertStrategyConfigEditorView();
  ...
  protected override void OnBeforeShowEditorConfig()
  {
    ...
    this.editorView.TargetConfig = this.TargetConfig as ConvertStrategyConfig;
