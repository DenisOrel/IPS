...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.ConfigEditor.EditorViewControllers.IdPartGroupEditorViewController
...
internal class IdPartGroupEditorViewController(IServiceProvider services) : BaseEditorViewController(services)
{
  private IdPartGroupEditorView editorView = new IdPartGroupEditorView();
  ...
  protected override void OnBeforeShowEditorConfig()
  {
    ...
    this.editorView.TargetConfig = this.TargetConfig as IdPartGroup;
