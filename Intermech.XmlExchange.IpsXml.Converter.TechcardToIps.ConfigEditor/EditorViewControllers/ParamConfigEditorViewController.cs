...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.ConfigEditor.EditorViewControllers.ParamConfigEditorViewController
...
internal class ParamConfigEditorViewController(IServiceProvider services) : BaseEditorViewController(services)
{
  private ParamConfigEditorView editorView = new ParamConfigEditorView();
  ...
  protected override void OnBeforeShowEditorConfig()
  {
    ...
    this.editorView.TargetConfig = this.TargetConfig as ParamConfig;
