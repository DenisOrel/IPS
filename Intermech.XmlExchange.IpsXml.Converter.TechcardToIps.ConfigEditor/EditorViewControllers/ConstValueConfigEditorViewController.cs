...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.ConfigEditor.EditorViewControllers.ConstValueConfigEditorViewController
...
[ConfigNodeType(NodeType.ConstValueConfig)]
internal class ConstValueConfigEditorViewController(IServiceProvider services) : 
  BaseEditorViewController(services)
{
  private ConstValueConfigEditorView editorView = new ConstValueConfigEditorView();
  ...
  protected override void OnBeforeShowEditorConfig()
  {
    ...
    this.editorView.TargetConfig = this.TargetConfig as ConstValueConfig;
