...
// Type: Intermech.XmlExchange.IpsXml.Converter.TechcardToIps.ConfigEditor.EditorViewControllers.ConvertationRulesConfigEditorViewController
...
[ConfigNodeType(NodeType.ConvertationRulesConfig)]
internal class ConvertationRulesConfigEditorViewController(IServiceProvider services) : 
  BaseEditorViewController(services)
{
  private ConvertationRulesConfigEditorView editorView = new ConvertationRulesConfigEditorView();
  ...
  protected override void OnBeforeShowEditorConfig()
  {
    ...
    this.editorView.TargetConfig = this.TargetConfig as ConvertationRulesConfig;
    this.editorView.TargetParentConfig = this.TargetParentConfig as BaseConvertableEntityWithParamsConfig;
