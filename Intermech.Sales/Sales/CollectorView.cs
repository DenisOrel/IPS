...
// Type: Intermech.Sales.CollectorView
...
public class CollectorView : UserControl, IView
{
  protected int imageIndex = -1;
  private IContainer components;

  public CollectorView() => this.InitializeComponent();
  ...
  {
    [DebuggerStepThrough] get => LocalizationHolder.rm.GetString("Sales_6");
  }
