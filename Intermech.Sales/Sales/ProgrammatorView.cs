...
// Type: Intermech.Sales.ProgrammatorView
...
public class ProgrammatorView : UserControl, IView
{
  protected int imageIndex = -1;
  private IContainer components;

  public ProgrammatorView() => this.InitializeComponent();
  ...
  {
    [DebuggerStepThrough] get => LocalizationHolder.rm.GetString("Sales_8");
  }
