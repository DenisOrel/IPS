...
// Type: Intermech.Sales.ProgrammatorViewProvider
...
internal class ProgrammatorViewProvider : IViewsProvider
{
  public ViewsInfo GetViews(ISelectedItems items, IServiceProvider services)
  {
    ViewsInfo views = new ViewsInfo();
    views.Add("Sales.Programmator", new ViewInfo(0, 0, typeof (ProgrammatorView)));
    return views;
  }
}
