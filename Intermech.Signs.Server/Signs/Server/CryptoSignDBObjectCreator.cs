...
// Type: Intermech.Signs.Server.CryptoSignDBObjectCreator
...
public class CryptoSignDBObjectCreator : IDBObjectCreator
{
  public IDBObject CreateObject(IUserSession uSession, Guid guid, DataTable objectParams)
  {
    return (IDBObject) new CryptoSignDBObject(uSession as UserSession, objectParams);
  }
}
