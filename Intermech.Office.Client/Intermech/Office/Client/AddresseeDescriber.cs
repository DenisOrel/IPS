...
// Type: Intermech.Office.Client.AddresseeDescriber
...
internal class AddresseeDescriber : IAttributePropertyDescriber
{
  [NotNull]
  ...
  {
    return (object) new AddresseeAttEditor(attributeId);
  }
  ...
  {
    return !(actualValue is long) ? (object) null : (object) new ObjectPropertyClass(Convert.ToInt64(actualValue));
  }
  ...
  public object GetAttributeValue(IElementInfo elementInfo, int attributeId, [CanBeNull] object propertyValue)
  {
    if (propertyValue != null && propertyValue != DBNull.Value)
    {
      switch (propertyValue)
      {
        ...
        case ObjectPropertyClass[] objectPropertyClassArray:
          return (object) objectPropertyClassArray[0].ObjectID;
        case long _:
