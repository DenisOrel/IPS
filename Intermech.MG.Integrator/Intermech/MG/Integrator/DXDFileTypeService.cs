...
// Type: Intermech.MG.Integrator.DXDFileTypeService
...
internal sealed class DXDFileTypeService(IIntegrator owner) : ContentBasedFileTypesService(owner)
{
  ...
  protected override bool VerifyFileContent(FileInfo fileInfo, Stream fileContent)
  {
    ...
    return MGProjectHelper.DefineProjectType(fileContent, out string _) == MGProjectType.Own;
  }
}
