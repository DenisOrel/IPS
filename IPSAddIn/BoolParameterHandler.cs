...
// Type: CSharpPlugin.BoolParameterHandler
...
internal sealed class BoolParameterHandler : ParameterHandler<bool>, IObligatoryParameterHandler
{
  ...
  public object Value(string text)
  {
    ...
    bool result;
    return !bool.TryParse(text, out result) ? (object) this.unknownValue : (object) result;
  }
}
