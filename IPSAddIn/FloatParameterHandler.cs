...
// Type: CSharpPlugin.FloatParameterHandler
...
internal sealed class FloatParameterHandler : ParameterHandler<double>, IObligatoryParameterHandler
{
  public FloatParameterHandler()
    : base(double.MinValue)
  {
  }
  ...
  public object Value(string text)
  {
    ...
    double result;
    return !double.TryParse(text, out result) ? (object) this.unknownValue : (object) result;
  }
}
