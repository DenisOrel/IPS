...
// Type: Intermech.Scripting.ScriptPad.PythonSyntaxModeProvider
...
internal sealed class PythonSyntaxModeProvider : ISyntaxModeFileProvider
{
  private readonly SyntaxMode mainMode;
  private readonly IList<SyntaxMode> allModes;

  public PythonSyntaxModeProvider()
  {
    this.mainMode = new SyntaxMode("Python.xshd", "Python", new string[2]
    {
      ".py",
      ".ipy"
    });
