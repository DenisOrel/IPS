...
// Type: Intermech.MRP.Orders.CompositionTracingEventHandler
...
/// <summary>
/// Делегат для событий от компонента "CompositionTracing"
/// </summary>
/// <param name="sender">Отправитель</param>
/// <param name="args">Аргументы события</param>
public delegate void CompositionTracingEventHandler(object sender, CompositionTracingEventArgs args);
