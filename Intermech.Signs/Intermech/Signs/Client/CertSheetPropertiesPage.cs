...
// Type: Intermech.Signs.Client.CertSheetPropertiesPage
...
public class CertSheetPropertiesPage : IPropertyPage, IPropertyPageSearchOptionEvents
{
  private IServiceProvider _provider;
  private CertSheetProperties _props;
  ...
  public object Control
  {
    get
    {
      ...
      {
        this._props = new CertSheetProperties();
  ...
  public string PageName => LocalizationHolder.rm.GetString("CertSheetPageName");
  ...
  public CertSheetPropertiesPage(IServiceProvider provider)
  {
    if (!(ServicesManager.GetService(typeof (ICurrentUserAndRole)) is ICurrentUserAndRole service) || !service.IsAdmin)
      return;
    this._provider = provider;
    ((IPropertyPagesService) this._provider.GetService(typeof (IPropertyPagesService)))?.AddPage(LocalizationHolder.rm.GetString("CertSheetSettingsCommon"), (IPropertyPage) this);
  }
}
