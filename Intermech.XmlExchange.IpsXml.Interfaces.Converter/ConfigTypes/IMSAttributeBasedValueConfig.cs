...
// Type: Intermech.XmlExchange.IpsXml.Interfaces.Converter.ConfigTypes.IMSAttributeBasedValueConfig
...
public class IMSAttributeBasedValueConfig : ValueConfig
{
  public IMSAttributeType sourceIMAttrType
  {
    get => MetaDataHelper.GetAttributeType(MetaDataHelper.GetAttributeID((object) this.Value));
  }
}
