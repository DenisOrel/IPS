...
// Type: Intermech.XmlExchange.IpsXml.Interfaces.Converter.ConfigTypes.SimpleValueConfig
...
public class SimpleValueConfig : ValueConfig
{
  public override ConfigFormat.AttrValueType ValueType => ConfigFormat.AttrValueType.avtSimple;
}
